        ...
        <div class="template-account__block">
            ...
            <form class="template-account__form" @submit.prevent="submitForm">
                ...
                <div class="text-end mt-3">
                    <a href="/user/forgot-password" class="template-account__form--link">Quên mật khẩu?</a>
                </div>
            ...
            <p class="template-account__question my-4">Bạn chưa có tài khoản? <a href="/user/register">Đăng ký ngay</a></p>
        </div>
    </div>
</template>
...
const submitForm = () => {
    ...
    if (isValid) {
        // Call API login
        axios.post(`${$route}/Customer/Login`, {
            email: email.value,
